                                        ...
                                        try {
                                            switch (n) {
                                                case 1: 
                                                    ...
                                                    MaterialesDB.insertarMaterial(con,  nombre, stock, coste, idA);
                                                    break;
                                        ...
                                        try {
                                            switch (n) {
                                                case 1: 
                                                    ...
                                                    ProveedorDB.insertarProveedor(con,  nombre, telefono);
                                                    break;
                                    ...
                                    try {
                                        switch (n) {
                                            case 1: 
                                                ...
                                                EmpleadoDB.insertarEmpleado(con,  cargo, nombre, tlf);
                                                break;
                                        ...
                                        try {
                                            switch (n) {
                                                case 1: 
                                                    ...
                                                    String tlf = scanner.nextLine();
                                                    TecnicoDB.insertarTecnico(con, tlf, nombre, tlf);
                                                    break;
                                        ...
                                        try {
                                            switch (n) {
                                                case 1: 
                                                    ...
                                                    System.out.println("Teléfono: ");
                                                    String tlf = scanner.nextLine();
                                                    AdministrativoDB.insertarAdministrativo(con, cargo, nombre, tlf);
                                                    break;
                                    ...
                                    try {
                                        switch (n) {
                                            case 1: 
                                                ...
                                                scanner.nextLine();
                                                EquipoDB.insertarEquipo(con, estado, fecha, modelo, marca, idT);
                                                break;
                                    ...
                                    try {
                                        switch (n) {
                                            case 1: 
                                                ...
                                                System.out.print("ID del presupuesto: ");
                                                int idP = scanner.nextInt();
                                                scanner.nextLine();

                                                FacturaDB.insertarFactura(con, cantidad, idA, idP);
                                                break;
                                            ...
                                            case 7:
                                                FacturaDB.verFacturas(con);
                                                System.out.print("ID de la factura para modificar ID Presupuesto: ");
                                                id = scanner.nextInt();
                                                scanner.nextLine();

                                                System.out.print("Nuevo ID Presupuesto: ");
                                                int nuevoIdP = scanner.nextInt();
                                                scanner.nextLine();

                                                FacturaDB.modificarIdP(con, id, nuevoIdP);
                                                break;
                                            case 8:
                                                System.out.println("Dime el nombre del fichero:");
                                                    String fichero = scanner.nextLine(); 
                                    ...
                                    try {
                                        switch (n) {
                                            case 1: 
                                                ...
                                                PresupuestoDB.insertarPresupuesto(con,  cantidad, idE, idC, idF);
                                                break;
                                        ...
                                        try {
                                            switch (n) {
                                                case 1: 
                                                    ...
                                                    ClienteDB.insertarCliente(con,  correo, nombre, calle);
                                                    break;
                                        ...
                                        try {
                                            switch (n) {
                                                case 1: 
                                                    ...
                                                    OrdenCompraDB.insertarOrdenCompra(con,  fecha, idP, idA);
                                                    break;
                                        ...
                                        try {
                                            switch (n) {
                                                case 1: 
                                                    ...
                                                    LineaCompraDB.insertarLineaCompra(con,  nlineas, ida, idM);
                                                    break;
