...
public class Reparaciones{
   ...
   public Reparaciones(String descripcionProblema, String equipoAfectado, String diagnostico,  String asignarReparadores, String asignarMateriales, double costeObra, int materiales, int tiempo) {
